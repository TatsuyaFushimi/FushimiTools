...
- ツール追加時は `仕様書/[tool-name].md` を必ず作成・維持する（利用サービス・動作概要をまとめたもの）
...
6. 仕様書/[tool-name].md を作成（新規）または更新（仕様変更時）
```
...
# Renderにデプロイ（QR Generator）
render deploys create srv-d8l6vem7r5hc739n7ci0 --confirm
```
